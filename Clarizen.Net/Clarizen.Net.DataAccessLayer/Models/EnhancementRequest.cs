...
namespace Clarizen.Net.DataAccessLayer.Models
{
    ...
    public partial class EnhancementRequest  : ClarizenEntity
    { /*Root*/
        ...
        [JsonProperty("RisksRate")]
        public string RisksRate { get; set; }

        [JsonProperty("RisksImpact")]
        public string RisksImpact { get; set; }

        [JsonProperty("RisksTotalScore")]
        public double RisksTotalScore { get; set; }
    }
